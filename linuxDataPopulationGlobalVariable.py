...
ump_uimapi_deploy = r"""{}/bin/pu -u {} -p {} {}/automated_deployment_engine deploy_probe uimpath {} {}""".format(uimpath, uim_username, uim_password, domain, uimapi_version, ump_robot_path)
